 ...
 * Generated at: 2023-01-12 03:34:25 UTC
...
public final class orderForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	input {height: 35px;}\r\n");
      out.write("	input[type=date] {width: 170px;}\r\n");
      out.write("	form div {margin: 10px;}\r\n");
      out.write("	input[type=submit],input[type=button],input[type=reset] {width: 55px; background: darkslateblue; border: none;\r\n");
      out.write("		border-radius: 5px; color: white; cursor: pointer;}\r\n");
      out.write("	input[type=button],input[type=reset] {background: gray;}\r\n");
      ...
      out.write("</div>");
      out.write("\r\n");
      out.write("	<div id=title><h1 class=center>배송 정보</h1></div>\r\n");
      out.write("	<div id=form>\r\n");
      out.write("		<form action=orderInfo.jsp method=post>\r\n");
      out.write("			<div><label for=name>성명</label><input type=text name=name id=name></div>\r\n");
      out.write("			<div><label for=date>배송일</label><input type=\"date\" name=date id=date></div>\r\n");
      out.write("			<div><label for=country>국가명</label><input type=\"text\" name=country id=country></div>\r\n");
      out.write("			<div><label for=code>우편번호</label><input type=\"text\" name=code id=code></div>\r\n");
      out.write("			<div><label for=addr>주소</label><input type=\"text\" name=addr id=addr></div>\r\n");
      out.write("			<div>\r\n");
      out.write("				<input type=button value=이전 onclick=back()>\r\n");
