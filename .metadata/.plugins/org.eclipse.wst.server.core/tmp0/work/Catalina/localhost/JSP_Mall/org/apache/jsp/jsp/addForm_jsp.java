 ...
 * Generated at: 2023-01-18 03:15:15 UTC
...
public final class addForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if (session.getAttribute("id") == null || !session.getAttribute("id").equals("admin")) {
      ...
      out.write("<script>alert(\"접근 권한이 없습니다.\"); history.back()</script>");
      ...
      out.write("	input[type=text],input[type=number] {height: 35px;}\r\n");
      out.write("	input[type=file] {border: 1px solid black; padding: 10px;}\r\n");
      out.write("	form div {margin: 10px;}\r\n");
      out.write("	input[type=submit] {height: 35px; width: 55px; background: aqua; border: none; border-radius: 5px; cursor: pointer;}\r\n");
      out.write("	label {width: 100px; display: inline-block;}\r\n");
      out.write("	#d {width: 300px;}\r\n");
      out.write("</style>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("	");
      ...
      out.write("		<form action=addPD.jsp method=post enctype=\"multipart/form-data\">\r\n");
      out.write("			<div><label for=i>상품 코드</label><input type=text name=id id=i></div>\r\n");
      out.write("			<div><label for=na>상품 이름</label><input type=text name=name id=na></div>\r\n");
      out.write("			<div><label for=p>가격</label><input type=\"number\" name=price id=p></div>\r\n");
      out.write("			<div><label for=d>상세 내용</label><input type=text name=des id=d></div>\r\n");
      out.write("			<div><label for=m>제조사</label><input type=\"text\" name=maker id=m></div>\r\n");
      out.write("			<div><label for=c>분류</label><input type=\"text\" name=category id=c></div>\r\n");
      out.write("			<div><label for=s>재고 수</label><input type=\"number\" name=stock id=s></div>\r\n");
      out.write("			<div>\r\n");
      out.write("				<label for=n>상태</label>\r\n");
      out.write("				<span>\r\n");
      ...
      out.write("				</span>\r\n");
      out.write("			</div>\r\n");
      out.write("			<div><label for=im>상품 이미지</label><input type=\"file\" name=image id=im></div>\r\n");
